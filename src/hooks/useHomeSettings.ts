...
const defaults: HomeSettings = {
  ...
  features: { items: [
    ...
    { tag: "KANBAN DE PEDIDOS", title: "Todos os seus\npedidos. Um\nlugar. Ao vivo.", description: "Kanban em tempo real sincronizado com Logzz, Coinzz e Hyppe via webhook.", bullets: ["Realtime — atualiza sem recarregar", "Etiquetas de impressão A4 e térmica", "Histórico completo de status", "Filtros avançados por período, cidade, produto"], image_url: "", image_side: "left", highlight: "Nunca mais perca um pedido de vista." },
    ...
    { tag: "REMARKETING AUTOMÁTICO", title: "Recupere vendas\nfrustradas no\npiloto automático.", description: "Cadência de 30 dias com mensagens de persuasão e desconto progressivo.", bullets: ["6 disparos automáticos (D1 a D25)", "Desconto progressivo configurável", "Detecta provider (Logzz/Coinzz/Hyppe)", "Link de checkout personalizado no WhatsApp"], image_url: "", image_side: "left", highlight: "Transforme frustração em faturamento." },
    { tag: "CHECKOUT HÍBRIDO 3-EM-1", title: "Logzz + Coinzz +\nHyppe. Zero\npedido perdido.", description: "3 providers de logística com fallback automático por CEP.", bullets: ["Prioridade configurável por checkout", "COD automático onde disponível", "Fallback para Correios se sem cobertura", "Hyppe como terceira opção de entrega"], image_url: "", image_side: "right", highlight: "O checkout que pensa antes de você." },
    { tag: "DISPAROS EM MASSA", title: "Fale com toda\nsua base em\num clique.", description: "Campanhas WhatsApp segmentadas por status, tags e comportamento.", bullets: ["Segmentação avançada de leads", "Templates personalizados", "Relatório de entrega em tempo real", "Agendamento de campanhas"], image_url: "", image_side: "left", highlight: "Broadcast inteligente para sua base inteira." },
  ] },
